...
train_proto = caffe_root + 'models/MobileNet/snapshot/zt_model/coco/mobilenet_deploy_class3_coco.prototxt'
train_model = caffe_root + 'models/MobileNet/snapshot/zt_model/coco/mobilenet_yolov3_coco_320_excavotor__iter_34000.caffemodel'  #should be your snapshot caffemodel

deploy_proto = './no_bn.prototxt'
save_model = './no_bn.caffemodel'
