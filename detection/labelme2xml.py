...
# 1.标签路径
labelme_path = "/media/aubopiazt/AA6CE0AF6CE07789/ubuntufile/datasets/detect/excavator_wheel/origin/"  # 原始labelme标注数据路径
saved_path = "/media/aubopiazt/AA6CE0AF6CE07789/ubuntufile/datasets/detect/excavator_wheel/voc/"  # 保存路径
...
for json_file_ in files:
    ...
    if not json_filename.replace('json', 'jpg'):
        print(json_filename.replace('json', 'jpg') + 'not exit !!!!')
        continue
...
trainval_percent = 0.95  # adjust trainval percentage
train_percent = 0.90  # adjust train percentage
