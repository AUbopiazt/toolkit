...
if __name__ == "__main__":
    ...
    IMG_DIR = "/media/aubopiazt/AA6CE0AF6CE07789/ubuntufile/datasets/detect/excavator_wheel/voc/JPEGImages"
    XML_DIR = "/media/aubopiazt/AA6CE0AF6CE07789/ubuntufile/datasets/detect/excavator_wheel/voc/Annotations"

    savepath = '/media/aubopiazt/AA6CE0AF6CE07789/ubuntufile/datasets/detect/excavator_wheel/voc'
    # if os.path.exists(savepath):
    #     shutil.rmtree(savepath)
    # os.mkdir(savepath)
    AUG_XML_DIR = savepath + '/Annotations'  # 存储增强后的XML文件夹路径Annotations
    mkdir(AUG_XML_DIR)

    AUG_IMG_DIR = savepath + '/JPEGImages'  # 存储增强后的影像文件夹路径
    mkdir(AUG_IMG_DIR)
