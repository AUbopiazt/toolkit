...
#测试图片
test_data   = "/media/wavereid/DATA/zt/toolkit/hyt_1.jpg"
#特征图路径
feature_map_path = "/media/wavereid/DATA/zt/toolkit/featureResult/"
pathPic = '/media/wavereid/DATA/zt/toolkit/pic/*.jpg'
...
timeUse = 0
kk = 0
for test_data in glob.glob(pathPic):
    s = s+1
...
show_data(feature.reshape(32,160,256),'conv1.jpg')
#第一个池化层输出的特征图
